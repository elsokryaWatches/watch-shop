  ...
  const handleEditClick = (product) => {
    ...
    if (crudType === "watches") {
      ...
      setWatchFormData({
        ...
        movement_en: product.movement_en || "",
        movement_ar: product.movement_ar || "",
        diameter_en: product.diameter_en || "",
        diameter_ar: product.diameter_ar || "",
        caseThickness_en: product.caseThickness_en || "",
